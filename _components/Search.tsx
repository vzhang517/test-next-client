...
type SearchType = 'User ID' | 'Status';
...
export default function Search({ userId, isAdmin }: SearchProps) {
  const [searchType, setSearchType] = useState<SearchType>('User ID');
  ...
  const handleSearch = async () => {
    try {
      ...
      const searchValue = searchType === 'User ID' ? value : statusValue;
  ...
  const renderResults = () => {
    ...
    const columns = searchType === 'User ID' ? userIDColumns : statusColumns;
