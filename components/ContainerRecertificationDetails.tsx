...
interface ContainerRecertificationDetailsProps {
  userId: string;
  isAdmin: boolean;
}

export default function ContainerRecertificationDetails({ userId, isAdmin }: ContainerRecertificationDetailsProps) {
  const [containers, setContainers] = useState([
    {
      ...
      certifyingAuthority: 'State Street Security',
    ...
    },
    {
      ...
      certifyingAuthority: 'Internal Audit Team',
    ...
    },
    {
      ...
      certifyingAuthority: 'External Auditor',
  ...
  return (
    <div className="bg-white shadow rounded-lg">
      <div className="px-6 py-4 border-b border-gray-200">
        <h2 className="text-2xl font-bold text-gray-900">Container Recertification Details</h2>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {containers.map((container) => (
                <tr key={container.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getComplianceColor(container.complianceLevel)}`}>
                      {container.complianceLevel}
                    </span>
                  </td>
